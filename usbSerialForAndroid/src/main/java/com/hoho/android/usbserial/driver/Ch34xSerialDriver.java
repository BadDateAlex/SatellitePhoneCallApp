...
public class Ch34xSerialDriver implements UsbSerialDriver {
    ...
    //Linear Control Register
    private static final int LCR_ENABLE_RX   = 0x80;//串口收
    private static final int LCR_ENABLE_TX   = 0x40;//串口发
    private static final int LCR_MARK_SPACE  = 0x20;//空格编码？？
    private static final int LCR_PAR_EVEN    = 0x10;//启用偶校验位
    private static final int LCR_ENABLE_PAR  = 0x08;//启用奇偶校验
    private static final int LCR_STOP_BITS_2 = 0x04;//设置停止位为两个
    private static final int LCR_CS8         = 0x03;//设置数据位为8位
    private static final int LCR_CS7         = 0x02;//7
    private static final int LCR_CS6         = 0x01;//6
    private static final int LCR_CS5         = 0x00;//5
